...
export default function PrivacyPage() {
  return (
    <main className="mx-auto min-h-dvh max-w-3xl space-y-8 px-4 py-10 sm:py-16">
      <div><Link to="/login" className="text-sm underline">← Wróć do logowania</Link><h1 className="mt-5 text-3xl font-bold">Polityka prywatności</h1><p className="mt-2 text-sm text-muted-foreground">Ostatnia aktualizacja: 12 września 2026 r.</p></div>
